...
const LOGIN_URL =
  import.meta.env.VITE_LOGIN_URL || "http://localhost:8081/api/auth/login";
    ...
    >
      <div className="text-center">
        ...
        <button
          ...
          className="px-3 py-3 rounded-[8px] bg-[#FFFFFF] flex items-center gap-1 mx-auto my-[25px] transition-all duration-200 hover:opacity-90"
        >
          <svg
            width="24"
            height="24"
          ...
          <div className="mx-3 text-2xl font-semibold">Login with GitHub</div>
        </button>
      </div>
    </div>
  );
